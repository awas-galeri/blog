        ...
        <main class="tm-main">
            ...
            <div class="row tm-row">
                    ...
                    <article class="col-12 col-md-6 tm-post">
                        ...
                        <a href="post.html" class="effect-lily tm-post-link tm-pt-60">
                            <div class="tm-post-link-inner">
                                <img src="asset2/img/img-01.jpg" alt="Image" class="img-fluid">
                            </div>
                        ...
                        <div class="d-flex justify-content-between tm-pt-45">
                            ...
                            <span class="tm-color-primary">{{ $b->created_at->diffForHumans() }}</span>
                        </div>
                        <hr>
                ...
                {{-- <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-60">
                        <div class=" tm-post-link-inner">
                            <img src="asset2/img/img-02.jpg" alt="Image" class="img-fluid">
                        </div>
                        <span class="position-absolute tm-new-badge">New</span>
                ...
                {{-- <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                            <img src="asset2/img/img-03.jpg" alt="Image" class="img-fluid">
                        </div>
                ...
                {{-- <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                            <img src="asset2/img/img-04.jpg" alt="Image" class="img-fluid">
                        </div>
                ...
                {{-- <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                            <img src="asset2/img/img-05.jpg" alt="Image" class="img-fluid">
                        </div>
                ...
                {{-- <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.html" class="effect-lily tm-post-link tm-pt-20">
                        <div class="tm-post-link-inner">
                            <img src="asset2/img/img-06.jpg" alt="Image" class="img-fluid">
                        </div>
